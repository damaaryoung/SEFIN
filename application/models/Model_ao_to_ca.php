...
class Model_ao_to_ca extends CI_Model
{

    // var $table = 'trans_so';
    var $column_order = array(null, "DATE_FORMAT(a.created_at,'%d/%m/%Y %H:%i:%s')", 'b.nomor_so', 'b.nama_so', 'c.nama', 'b.nama_marketing', 'd.nama_lengkap', 'e.nama');
    var $column_search = array("DATE_FORMAT(a.created_at,'%d/%m/%Y %H:%i:%s')", 'b.nomor_so', 'b.nama_so', 'c.nama', 'b.nama_marketing', 'd.nama_lengkap', 'e.nama');
    ...
    function sql_ao()
    {
        ...
        $this->db->where('b.id_trans_ao !=', NULL);
        $this->db->where('b.id_trans_ca', NULL);
