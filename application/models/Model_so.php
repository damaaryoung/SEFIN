...
class Model_so extends CI_Model
{
    ...
    // var $table = 'trans_so';
    var $column_order = array(null, 'a.nomor_so', 'd.nama', 'b.nama', "DATE_FORMAT(a.created_at,'%d/%m/%Y %H:%i:%s')", 'a.nama_so', 'c.nama_lengkap', ' a.status_das', ' a.status_hm');
    var $column_search = array('a.nomor_so', 'd.nama', 'b.nama', "DATE_FORMAT(a.created_at,'%d/%m/%Y %H:%i:%s')", 'a.nama_so', 'c.nama_lengkap', ' a.status_das', ' a.status_hm');
