...
class Model_collection extends CI_Model{
	...
	function data_collection_daily(){
        ...
        $this->db->query("SELECT CURDATE() INTO @pv_tgl;"); //tgl hari kerja hari ini
		...
		AND tahun=YEAR(@pv_tgl  - INTERVAL 1 MONTH) INTO @tgl_awal;"); //hari kerja Bulan Lalu
