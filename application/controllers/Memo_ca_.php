...
class Memo_ca extends CI_Controller {
	...
	public function index()
	{
		...
		if($count > 0){
	        ...
	        $data['nama_asuransi_jaminan'] = $x->nama_asuransi_jaminan;
	        $data['jangka_waktu_jaminan'] = $x->jangka_waktu_jaminan;
	        $data['nilai_pertanggungan_jaminan'] = $x->nilai_pertanggungan_jaminan;
	        $data['jatuh_tempo_jaminan'] = $x->jatuh_tempo_jaminan;
			...
			$data['biaya_transport'] = $x->biaya_transport;
			$data['biaya_pendidikan'] = $x->biaya_pendidikan;
			$data['biaya_telp_listr_air'] = $x->biaya_telp_listr_air;
