                                    ...
                                    <div class="col-md-7">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="fasilitas_agunan" name="fasilitas_agunan[]" onkeyup="this.value = this.value.toUpperCase()" value="0">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="exampleInputEmail1">Listrik (Kwh)<span class="required_notification">*</span></label>
                                                <input type="text" class="form-control" id="listrik_agunan" name="listrik_agunan[]" onkeypress="return hanyaAngka(event)" value="0">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="perusahaan_penilai_independen[]" onkeyup="this.value = this.value.toUpperCase()" value="0">
                                            </div>
                                            <div class="form-group col-md-6">
