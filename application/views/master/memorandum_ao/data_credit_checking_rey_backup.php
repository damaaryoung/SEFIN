                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control uang" name="nilai_taksasi_bangunan[]" value="0">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="exampleInputEmail1" >Nilai Taksasi Agunan<span class="required_notification">*</span></label>
                                                <input type="text" class="form-control uang" name="nilai_taksasi_agunan[]" value="0">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control uang" name="nilai_likuidasi_agunan[]" value="0">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label for="exampleInputEmail1" >Plafon Kredit<span class="required_notification">*</span></label>
                                                <input type="text" class="form-control uang" id="plafon_kredit_detail" name="plafon_kredit_detail" aria-describedby="" placeholder="">
                                            </div> 
                                           
                                            <div class="form-group">
                                                <label>Jangka Waktu<span class="required_notification">*</span></label>
                                                <select name="jangka_waktu_detail" class="form-control" >
                                                    <option value="">-- Pilih --</option>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label for="exampleInputEmail1" >Suku Bunga<span class="required_notification">*</span></label>
                                                    <input type="text" class="form-control" id="suku_bunga_detail" name="suku_bunga_detail" aria-describedby="" placeholder="">
                                                </div>   
                                                 <div class="form-group col-md-6">
                                                    <label for="exampleInputEmail1" >Angsuran / Bln<span class="required_notification">*</span></label>
                        ...
                        <div class="card-body collapse" id="collapse_5">
                            <div class="row">
                                <div class="col-md-4" id="ktp">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">KTP</label>
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_ktp" data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4" id="kk">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Kartu Keluarga</label>
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_kk" data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4" id="sertifikat">
                                    <div class="form-group">
                                        <label>Sertifikat</label>
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_sertifikat" data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4" id="pbb">
                                    <div class="form-group">
                                        <label for="exampleInput1" class="bmd-label-floating">Lampiran PBB</label>
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_pbb " data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4" id="imb">
                                    <div class="form-group">
                                        <label for="exampleInput1" class="bmd-label-floating">IMB</label>
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_imb " data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInput1" class="bmd-label-floating">Lampiran KTP Pasangan</label>
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_ktp_pasangan" data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInput1" class="bmd-label-floating">Lampiran Buku Nikah</label>
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_buku_nikah" data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_skk_detail" data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_slip_gaji_detail" data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_buku_tabungan_detail" data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_sku_detail" data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-info btn-sm edit submit" data-toggle="modal" data-target="#modal_edit_lamp_foto_usaha_detail1" data-id="65"><i class="fa fa-pencil-alt"></i></button>
                                        <div class="form-group form-file-upload form-file-multiple">
                                            <div class="col-md-6">
...
<div class="modal fade in" id="modal_edit_lamp_buku_tabungan_detail" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class='modal-body text-center'>
                <div class="form-group">
                    <label for="exampleInputFile">Ubah Lampiran Buku Tabungan</label>
                    <div class="input-group">
   ...
   get_asaldata = function(opts){
    ...
    $('#data_pengajuan').on('click', '.edit', function(e){
        ...
        .done(function(response){
            ...
            var angka = (rubah(data.fasilitas_pinjaman[0].plafon));
            $('#form_detail input[id=plafon_deb]').val(angka);
            ...
            if (data.data_debitur.status_nikah == "NIKAH") {
            ...
            if (data.data_debitur.status_nikah == "CERAI") {
            ...
            if (data.data_debitur.pekerjaan.nama_pekerjaan == "KARYAWAN") {
                document.getElementById("pek_deb_karyawan").selected = "true";
            }else
            if (data.data_debitur.pekerjaan.nama_pekerjaan == "PNS") {
                document.getElementById("pek_deb_pns").selected = "true";  
            }
            if (data.data_debitur.pekerjaan.nama_pekerjaan == "WIRASWASTA") {
            ...
            var m = [
            '<a class="example-image-link target="window.open()" href="<?php echo $this->config->item('img_url') ?>'+data.data_debitur.lampiran.lamp_buku_tabungan+'" data-lightbox="example-set" data-title="Lampiran IMB Debitur"><img class="thumbnail img-responsive" alt="" src="<?php echo $this->config->item('img_url') ?>'+data.data_debitur.lampiran.lamp_buku_tabungan+'" /> </a>'
            ].join('\n');
            html5.push(m);
    ...
    $('#data_creditchecking').on('click', '.edit', function(e){
        ...
        .done(function(response){
            ...
            $('#form_edit_foto_usaha_detail input[type=hidden][name=id_foto_usaha]').val(data.data_pasangan.id);
            ...
            .done(function(res){
                ...
                if (data.data_debitur.pekerjaan.alamat.provinsi.id == ''+data.data_debitur.pekerjaan.alamat.provinsi.id+'') {
                    document.getElementById(''+data.data_debitur.pekerjaan.alamat.provinsi.id+'').selected = "true";
                }
            })
            ...
            var select_pekerjaan_pas = [];
                var option_pekerjaan_pas = [
                    '<option value="'+data.data_pasangan.pekerjaan.nama_pekerjaan+'">'+data.data_pasangan.pekerjaan.nama_pekerjaan+'</option>',
                    '<option value="KARYAWAN">KARYAWAN</option>',
                    '<option value="PNS">PNS</option>',
                    '<option value="WIRASWASTA">WIRASWASTA</option>',
                    '<option value="PENGURUS_RT">IBU RUMAH TANGGA</option>'
