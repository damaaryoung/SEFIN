  ...
  <section class="content">
    <div class="container-fluid">
      <div class="callout callout-info">
        ...
        <form class="form-horizontal" id="update_task_assigment">
          ...
          <div class="form-group row ml-1 mr-1">
            <button type="submit" id="submit" class="btn btn-primary" style="float: right;">Simpan1</button>
          </div>
        </form>
      </div>
    </div>
...
$('#update_task_assigment').submit(function(e){
  e.preventDefault();
  // alert('test');
  if($('#no_rekening').val() == ""){
  ...
  $.ajax({
    url:"<?php echo base_url();?>assignment_collection/editTaskAssigment",
    type: "POST",
    dataType:"JSON",
    data:{
