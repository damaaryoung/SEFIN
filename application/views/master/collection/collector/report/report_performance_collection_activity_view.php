            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Report Data Performance Collection Activity</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="callout callout-info">
                <h5 class="text-center">
                    <strong>Report Data Performance Collection Activity</strong>
                </h5>
                <div class="row">
...
function get_dataTable(draw){
  ...
  var table = $("#listData").DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo base_url();?>assignment_collection/ajax_list_collection_performance",
                        "type": "POST",
                        "data":{
                            "kode_area": kode_area,
                            "kode_cabang" : kode_cabang,
