...
<div class="modal-header">
    <center><font size="4"><b>NPL Konsolidasi</b></font></center>
</div>
...
<script>
    ...
    var data_tgl = $('input[name="date-fid-compre"]').val();

    var winURL        = "<?php echo base_url('modal_bootstrap_controller/fid_compre_console_export') ?>";
    var winName       = "LAPORAN";
