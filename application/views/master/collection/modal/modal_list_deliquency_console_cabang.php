...
<div class="modal-header">
    <center><font size="4"><b>Deliquency Cabang</b></font></center>
</div>
<div class="modal-body" style="overflow-x:auto">
    <input type="hidden" name="date_deliquency_cabang" id="date_deliquency_cabang"/>
...
<script>
    function deliquency_console_export() {
        var data_tgl = $('input[name="date_deliquency_cabang"]').val();
        var data_kode_cabang = $('input[name="kode_cabang"]').val();

        var winURL        = "<?php echo base_url('modal_bootstrap_controller/deliquency_console_cabang_export') ?>";
        var winName       = "LAPORAN";
