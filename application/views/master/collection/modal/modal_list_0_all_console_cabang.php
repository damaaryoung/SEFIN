...
<div class="modal-header">
    <center><font size="4"><b>Bucket 0 ALL Cabang</b></font></center>
</div>
...
<script>
    ...
    var data_tgl = $('input[name="date_0_all_console_cabang"]').val();
    var data_kode_cabang = $('input[name="kode_cabang"]').val();

    var winURL        = "<?php echo base_url('modal_bootstrap_controller/bucket_0_all_console_export_cabang') ?>";
    var winName       = "LAPORAN";
