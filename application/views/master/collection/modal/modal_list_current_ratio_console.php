...
<div class="modal-header">
    <center><font size="4"><b>Current Ratio Konsolidasi</b></font></center>
</div>
...
<script>
    ...
    var data_tgl = $('input[name="date-current-ratio"]').val();

    var winURL        = "<?php echo base_url('modal_bootstrap_controller/current_ratio_console_export') ?>";
    var winName       = "LAPORAN";
