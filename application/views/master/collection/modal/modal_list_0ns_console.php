...
<div class="modal-header">
    <center><font size="4"><b>Bucket 0 NS Konsolidasi</b></font></center>
</div>
...
<script>
    ...
    var data_tgl = $('input[name="date_bucket0_ns_console"]').val();

    var winURL        = "<?php echo base_url('modal_bootstrap_controller/bucket_0ns_console_export') ?>";
    var winName       = "LAPORAN";
