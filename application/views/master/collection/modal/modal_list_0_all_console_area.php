...
<div class="modal-header">
    <center><font size="4"><b>Bucket 0 ALL Area</b></font></center>
</div>
<div class="modal-body" style="overflow-x:auto">
    <input type="hidden" name="date_0_all_console_area" id="date_0_all_console_area"/>
...
<script>
    ...
    var data_tgl = $('input[name="date_0_all_console_area"]').val();
    var data_kode_area = $('input[name="kode_area"]').val();

    var winURL        = "<?php echo base_url('modal_bootstrap_controller/bucket_0_all_console_export_area') ?>";
    var winName       = "LAPORAN";
