...
<div class="modal-header">
    <center><font size="4"><b>Daftar NPL Cabang</b></font></center>
</div>
<div class="modal-body" style="overflow-x:auto">
    <input type="hidden" name="date_npl_console_cabang" id="date_npl_console_cabang"/>
...
<div class="modal-footer">
    <a href="javascript:void(0)" onclick="npl_console_export()" class="btn btn-primary">Export to Excel</a>
    <a href="javascript:void(0)" data-dismiss="modal" class="btn btn-danger">Tutup</a>
</div>
<script>
    function npl_console_export() {
    var data_tgl = $('input[name="date_npl_console_cabang"]').val();
    var data_kode_cabang = $('input[name="kode_cabang"]').val();

    var winURL        = "<?php echo base_url('modal_bootstrap_controller/npl_console_export_cabang') ?>";
    var winName       = "LAPORAN";
