                ...
                <div class="card">
                    <div class="card-body">
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table id="table_data_pic" class="table table-bordered table-hover table-sm" style="font-size: 12px;white-space: nowrap; width: 100%;">
                                ...
                                <!-- <tbody id="data_pic" style="font-size: 12px">
                                </tbody> -->
                            </table>
                        </div>
                    </div>
    ...
    $(function() {
        ...
        function tampil_data_pic() {
            $('#table_data_pic').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('Pic_controller/get_data_pic') ?>",
                    "type": "POST"
                },
        ...
        $('#table_data_pic').on('click', '.edit', function(e) {
            e.preventDefault();
        ...
        //delete
        $('#table_data_pic').on('click', '.delete', function(e) {
            e.preventDefault();
            var id = $(this).attr('data');
