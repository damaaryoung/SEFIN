        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form role="form"  id="form_tambah_provinsi">
                <div class="card-body">
