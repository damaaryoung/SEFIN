                ...
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-md-4 input-group">
                           ...
                           <!--  <button type="button" id="uploadOCRKtpdebitur" data-toggle="modal" class="btn btn-primary float-right check">
                                <i class="fa fa-camera"></i>
                                <input type="file" id="inp1" name="inp" class="custom-file-input">
                            </button> -->
                            <div class="upload-btn-wrapper">
                              <button class="btn_file"><i class="fa fa-camera"></i></button>
                              <input type="file" name="inp1" id="inp1"/>
                          </div>
                          <!-- <input type="file" name="inp1" id="inp1" class="custom-file-input"> -->
...
<div class="modal fade in" id="modal_foto_ktp">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="file" id="inp1" name="inp" onchange="readFile()" class="custom-file-input">
            ...
            <div class="modal-footer">
                <button type="submit" id="take"  class="btn btn-success">Save</button>
            </div>
        </div>
    </div>
</div>
...
$('.uang').mask('0.000.000.000', {
    ...
    function take_snapshot() {
            // Webcam.snap(function(data_uri) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        // $('[name="agama"]').val(data.Agama.value);
        ...
        document.getElementById("inp1").addEventListener("change", next_upload_foto);

        function next_upload_foto(inp1) {
