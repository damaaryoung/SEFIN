                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" id="tgl_lahir_pas" name="tgl_lahir_pas" class="form-control" data-date-format="d-m-Y" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
    ...
    <script src="<?php echo base_url('assets/dist/js/datepicker.js') ?>"></script>    <script src="<?php echo base_url('assets/dist/js/datepicker.en.js') ?>"></script>
    <script src="<?php echo base_url('assets/dist/js/compressor.js') ?>"></script>
    <script src="<?php echo base_url('assets/plugins/bs-custom-file-input/bs-custom-file-input.min.js') ?>"></script>
    <?php $this->load->view('master/memorandum_so/add_credit_js.php'); ?>
