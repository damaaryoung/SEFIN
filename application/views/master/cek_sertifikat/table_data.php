      ...
      <tr>
        ...
        <td>
          <div class="btn-group">
              ...
              <a href="<?= base_url().'report/Cek_sertifikat_report/index/'.$key["id"]; ?>" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="right" title="Generate PDF"><i class="fas fa-download"></i></a>
            </div>
        </td>
      </tr>
    <?php $no++; endforeach; ?>
