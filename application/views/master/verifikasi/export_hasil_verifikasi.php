        ...
        <table class="border" style="width: 100%;">
            ...
            <?php foreach($result_debitur as $r): ?>
                ...
                <tr>
                    ...
                    <td class="str"><?php echo $r->no_ktp_debitur ?></td>
                    ...
                    <td class="str"><?php echo $r->no_npwp_debitur ?></td>
                    ...
                    <?php if ($count_pasangan->jml_pasangan != 0) { ?>
                        <?php foreach($result_pasangan as $rpas): ?> 
                            <?php if ($rpas->id_trans_so == $r->id_trans_so) { ?>
                                ...
                                <td class="str"><?php echo $rpas->no_ktp_pasangan ?></td>
                                ...
                                <td class="str"><?php echo $rpas->no_npwp_pasangan ?></td>
                        ...
                        <?php if ($count_penjamin->jml_penjamin == 1) { ?>
                            <?php foreach($result_penjamin as $rpen): ?>
                                <?php if($rpen->id_trans_so == $r->id_trans_so) { ?>
                                    ...
                                    <td class="str"><?php echo $rpen->no_ktp_penjamin ?></td>
                                    ...
                                    <td class="str"><?php echo $rpen->no_npwp_penjamin ?></td>
