<?php
    ...
    header("Content-Disposition: attachment; filename=EXPORT VERIFIKASI - PASANGAN.xls");
?>
...
<html lang="en">
    <head>
        <title>EXPORT VERIFIKASI - PASANGAN</title>
    ...
    <body>
        <table class="border" style="width: 100%;">
            ...
            <?php $no=1; ?>
            <?php foreach($result_pasangan as $r): ?>
                <tr>
                    ...
                    <td class="border"><?php echo $r->nama_pasangan ?></td>
                    <td class="border"><?php echo $r->tempat_lahir_pasangan?></td>
                    <td class="border"><?php echo $r->tgl_lahir_pasangan ?></td>
                    <td class="border"><?php echo $r->alamat_pasangan?></td>
                    <td class="border"><?php echo $r->no_ktp_pasangan ?></td>
                    <td class="border" style="text-align: center"><?php echo $r->jml_verif_pasangan ?></td>
                    <td class="border"><?php echo $r->verif_pasangan ?></td>
                    <td class="border" style="text-align: left"><?php echo $r->update_verif_pasangan ?></td>
                    <td class="border"><?php echo $r->no_npwp_pasangan ?></td>
                    <td class="border" style="text-align: center"><?php echo $r->jml_verif_npwp_pasangan ?></td>
                    <td class="border"><?php echo $r->verif_npwp_pasangan ?></td>
                    <td class="border" style="text-align: left"><?php echo $r->update_verif_npwp_pasangan ?></td>
                    <?php if ($r->jml_verif_pasangan == 1 && $r->jml_verif_npwp_pasangan == 1) { ?>
                        <td class="border" style="text-align: right">Rp 18.500,00</td>
                    <?php } else if ($r->jml_verif_pasangan == 1 && $r->jml_verif_npwp_pasangan == 2) {?>
                        <td class="border" style="text-align: right">Rp 30.000,00</td>
                    <?php } else if ($r->jml_verif_pasangan == 2 && $r->jml_verif_npwp_pasangan == 1) {?>
                        <td class="border" style="text-align: right">Rp 25.500,00</td>
                    <?php } else if ($r->jml_verif_pasangan == 2 && $r->jml_verif_npwp_pasangan == 2) {?>
                        <td class="border" style="text-align: right">Rp 37.000,00</td>
                    <?php } else if ($r->jml_verif_pasangan == 1) {?>
                        <td class="border" style="text-align: right">Rp 7.000,00</td>
                    <?php } else if ($r->jml_verif_pasangan == 2) {?>
                        <td class="border" style="text-align: right">Rp 14.000,00</td>
                    <?php } else if ($r->jml_verif_npwp_pasangan == 1) {?>
                        <td class="border" style="text-align: right">Rp 11.500,00</td>
                    <?php } else if ($r->jml_verif_npwp_pasangan == 2) {?>
