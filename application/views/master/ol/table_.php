                ...
                <div class="card">
                    <div class="card-body">
                        <div class="box-body table-responsive no-padding">
                            <table id="table_ol" class="table table-bordered table-hover table-sm" style="white-space: nowrap;">
                                    ...
                                    <?php if ($result != 1) : ?>
                                        ...
                                        foreach ($result['data'] as $res) : ?>
                                            <?php if ($res['status_caa'] == 'recommend') : ?>
                                                <tr ondblclick="app_edit_ol(<?php echo $res['id_trans_so'] ?>)" style="cursor:pointer">
                                                    <td style="width: 70px;">
                                                        <form method="post" target="_blank" action="<?php echo base_url() . 'index.php/report/Memo_pfka' ?>">
