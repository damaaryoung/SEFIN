<!-- form lihat data -->
<div id="lihat_menu" class="content-wrapper" style="padding-left: 15px; padding-right: 15px;">
                    ...
                    <div class="card-body">
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody id="data_menu" style="font-size: 13px">
                                </tbody>
                            </table>
                        </div>
                    </div>
...
<!-- form tambah -->
<div id="lihat_tambah_menu" class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form role="form" id="form_tambah_menu"  > 
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Icon</label>
                                    <input type="text" class="form-control" name="icon" placeholder="Isi Icon">
                                </div>
                            </div>
...
<!-- form ubah -->
<div id="lihat_ubah_menu" class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
...
<script>
   $(function(){
        ...
        hide_all = function(){
            $('#lihat_menu').hide();
            $('#lihat_tambah_menu').hide();
            $('#lihat_ubah_menu').hide();
        }
        hide_all();
        $('#lihat_menu').show();
        ...
        $('#click-add-menu').click(function(){
            hide_all();
            $('#lihat_tambah_menu').show();
        });

        get_menu = function(opts, id){
            var url = '<?php echo config_item('api_url') ?>api/menu/master';
       ...
       tambah_menu = function(opts){
        ...
        //delete
        $('#data_menu').on('click','.delete',function(e){
        e.preventDefault();
        ...
        $('#form_tambah_menu').on('submit',function(e){
            ...
            formData.append('icon',$('input[name=icon]',this).val());
