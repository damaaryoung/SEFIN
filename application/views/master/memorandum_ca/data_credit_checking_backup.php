                ...
                <div class="card">
                    <div class="card-body">
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table id="table_data_ca" class="table table-bordered table-hover table-sm" style="white-space: nowrap;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <div class="box-body table-responsive no-padding">
                            <table id="example3" class="table table-bordered table-hover table-sm" style="white-space: nowrap;">
...
<div id="lihat_detail" class="content-wrapper" style="padding-left: 15px; padding-right: 15px;">
    ...
    <div id="form_detail" method="GET">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="sumber_penghasilan" class="form-control" style="width: 100%;">
                                                <option value="">--Pilih--</option>
                                                <option id="gaji" value="GAJI">GAJI</option>
                                                <option id="bisnis" value="BISNIS">BISNIS / USAHA</option>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-7">
                                                ...
                                                <select name="pemasukan_per_bulan" class="form-control" style="width: 100%;">
                                                    <option value="">--Pilih--</option>
                                                    <option value="A">
                                                        < RP.1.000.000</option> <option value="B">RP.1.000.000,- s/d RP.2.000.000,-
                                                    </option>
                                                    <option value="C"> > RP.2.000.000,- s/d RP.5.000.000,-</option>
                                                    <option value="D"> > RP.5.000.000,- s/d RP.10.000.000,-</option>
                                                    <option value="E"> > RP.10.000.000,-</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-5">
                                                ...
                                                <select name="frek_trans_pemasukan" class="form-control ">
                                                    <option value="">Pilih</option>
                                                    <option value="A">0-5 Kali</option>
                                                    <option value="B">6-10 Kali</option>
                                                    <option value="C">>10 Kali</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-5">
                                                ...
                                                <select name="frek_trans_pengeluaran" class="form-control ">
                                                    ...
                                                    <option value="A">0-5 Kali</option>
                                                    <option value="B">6-10 Kali</option>
                                                    <option value="C">11-15 Kali</option>
                                                    <option value="D">>15 Kali</option>
                                                </select>
                                            </div>
                                        </div>
                ...
                <div class="box-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="sumber_penghasilan_ca" class="form-control" style="width: 100%;">
                                                <option value="">--Pilih--</option>
                                                <option id="gaji_detail" value="GAJI">GAJI</option>
                                                <option id="bisnis_detail" value="BISNIS">BISNIS / USAHA</option>
                                                <option id="lainnya_detail" value="LAINNYA">LAINNYA</option>
                                            </select>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-7">
                                                ...
                                                <select name="pemasukan_per_bulan_ca" class="form-control" style="width: 100%;">
                                                    <option value="">--Pilih--</option>
                                                    <option id="pemasukan_a_detail" value="A">
                                                        < RP.1.000.000</option> <option id="pemasukan_b_detail" value="B">RP.1.000.000,- s/d RP.2.000.000,-
                                                    </option>
                                                    <option id="pemasukan_c_detail" value="C"> > RP.2.000.000,- s/d RP.5.000.000,-</option>
                                                    <option id="pemasukan_d_detail" value="D"> > RP.5.000.000,- s/d RP.10.000.000,-</option>
                                                    <option id="pemasukan_e_detail" value="E"> > RP.10.000.000,-</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-5">
                                                <label for="exampleInput1" class="bmd-label-floating">Frek. Trans Pemasukan</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="form-group col-md-7">
                                                ...
                                                <select name="pengeluaran_per_bulan_ca" class="form-control" style="width: 100%;">
                                                    <option value="">--Pilih--</option>
                                                    <option id="pengeluaran_a_detail" value="A">
                                                        < RP.1.000.000</option> <option id="pengeluaran_b_detail" value="B">RP.1.000.000,- s/d RP.2.000.000,-
                                                    </option>
                                                    <option id="pengeluaran_c_detail" value="C"> > RP.2.000.000,- s/d RP.5.000.000,-</option>
                                                    <option id="pengeluaran_d_detail" value="D"> > RP.5.000.000,- s/d RP.10.000.000,-</option>
                                                    <option id="pengeluaran_e_detail" value="E"> > RP.10.000.000,-</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-5">
                                                <label for="exampleInput1" class="bmd-label-floating">Frek. Trans Pengeluaran</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="sumber_dana_setoran_ca" class="form-control ">
                                                <option value="">Pilih</option>
                                                <option id="gaji_setoran_detail" value="GAJI">GAJI</option>
                                                <option id="bisnis_setoran_detail" value="BISNIS USAHA">BISNIS/USAHA</option>
                                                <option id="lainnya_setoran_detail" value="LAINNYA">LAINNYA</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInput1" class="bmd-label-floating">Tujuan Pengeluaran Dana</label>
                    ...
                    <form id="form_edit_penyimpangan">
                        <div class="card mb-3">
                            ...
                            <div class="card-body collapse" id="collapse_19">
                                <input type="hidden" name="id_data_penyimpangan">
                                <div class="form-group">
                                    <label for="exampleInputEmail1" class="bmd-label-floating">Penyimpangan Struktur Dan Resiko</label>
                    ...
                    <form id="form_edit_data_rekomendasi_pinjaman">
                        <input type="hidden" name="id_data_rekomendasi_pinjaman">
                        <div class="card mb-3">
                            <div class="card-header bg-gradient-danger" data-toggle="collapse" href="#collapse_20" role="button" aria-expanded="false" aria-controls="collapse_20">
                                <a class="text-light">
                                    <b>REKOMENDASI PINJAMAN</b>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label for="exampleInputEmail1" class="bmd-label-floating">Bunga Pinjaman<span class="required_notification">*</span></label>
                                                <div class="input-group ">
                                                    <input type="text" class="form-control" id="recom_bunga_pinjaman_detail" name="recom_bunga_pinjaman_detail" onkeyup="angsuran_perbulan_detail_ca();">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">%</span>
                                                    </div>
                                                </div>
            ...
            <div class="modal fade in" id="modal_tambah_analisa_cc" data-keyboard="false" data-backdrop="static">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <input type="text" id="add_id_so_analisa_cc" name="add_id_so_analisa_cc">
                                <input type="text" id="edit_id_info_analisa_cc" name="edit_id_info_analisa_cc">
                                <div class="col-md-6">
                                    <div class="form-group">
        ...
        <script type="text/javascript">
            ...
            $('#data_creditchecking').on('click', '.edit', function(e) {
                ...
                get_credit_checking({}, id)
                    .done(function(response) {
                        ...
                        $('#form_modal_tambah_penjamin input[type=hidden][name=add_id_so_penjamin]').val(data.id_trans_so);
                        $('#form_penjamin input[type=hidden][name=id_trans_so_pen]').val(data.id_trans_so);
                        $('#form_modal_tambah_analisa_cc input[type=text][name=add_id_so_analisa_cc]').val(data.id_trans_so);
                        $('#form_modal_agunan_sertifikat input[type=hidden][name=id_trans_so_aguanan]').val(data.id_trans_so);
                ...
                get_detail_ca({}, id)
                    .done(function(response) {
                        ...
                        if (data.data_keuangan.sumber_penghasilan == "GAJI") {
                            document.getElementById("gaji_detail").selected = "true";
                        } else
                        if (data.data_keuangan.sumber_penghasilan == "BISNIS") {
                            document.getElementById("bisnis_detail").selected = "true";
                        } else
                        if (data.data_keuangan.sumber_penghasilan == "LAINNYA") {
                            document.getElementById("lainnya_detail").selected = "true";
                        }

                        if (data.data_keuangan.pemasukan_per_bulan == "A") {
                            document.getElementById("pemasukan_a_detail").selected = "true";
                        } else
                        if (data.data_keuangan.pemasukan_per_bulan == "B") {
                            document.getElementById("pemasukan_b_detail").selected = "true";
                        } else
                        if (data.data_keuangan.pemasukan_per_bulan == "C") {
                            document.getElementById("pemasukan_c_detail").selected = "true";
                        } else
                        if (data.data_keuangan.pemasukan_per_bulan == "D") {
                            document.getElementById("pemasukan_d_detail").selected = "true";
                        } else
                        if (data.data_keuangan.pemasukan_per_bulan == "E") {
                            document.getElementById("pemasukan_e_detail").selected = "true";
                        }
                        ...
                        if (data.data_keuangan.pengeluaran_per_bulan == "A") {
                            document.getElementById("pengeluaran_a_detail").selected = "true";
                        } else
                        if (data.data_keuangan.pengeluaran_per_bulan == "B") {
                            document.getElementById("pengeluaran_b_detail").selected = "true";
                        } else
                        if (data.data_keuangan.pengeluaran_per_bulan == "C") {
                            document.getElementById("pengeluaran_c_detail").selected = "true";
                        } else
                        if (data.data_keuangan.pengeluaran_per_bulan == "D") {
                            document.getElementById("pengeluaran_d_detail").selected = "true";
                        } else
                        if (data.data_keuangan.pengeluaran_per_bulan == "E") {
                            document.getElementById("pengeluaran_e_detail").selected = "true";
                        }
                        ...
                        if (data.data_keuangan.frek_trans_pengeluaran == "D") {
                            document.getElementById("frek_peng_d").selected = "true";
                        }

                        if (data.data_keuangan.sumber_dana_setoran == "GAJI") {
                            document.getElementById("gaji_setoran_detail").selected = "true";
                        } else
                        if (data.data_keuangan.sumber_dana_setoran == "BISNIS USAHA") {
                            document.getElementById("bisnis_setoran_detail").selected = "true";
                        } else
                        if (data.data_keuangan.sumber_dana_setoran == "LAINNYA") {
                            document.getElementById("lainnya_setoran_detail").selected = "true";
                        }
            ...
            update_penyimpangan = function(opts, id) {
                var data = opts;
            ...
            //SUBMIT ASPEK KUALITATIF
            $('#form_edit_penyimpangan').on('submit', function(e) {
                var id = $('input[name=id_data_penyimpangan]', this).val();
                console.log(id)
                e.preventDefault();
                var formData = new FormData();

                var data = {
                    penyimpangan_struktur: $('textarea[name=penyimpangan_struktur_detail]', this).val(),
                }


                update_penyimpangan(data, id)
                    .done(function(res) {
                        var data = res.data;
                        bootbox.alert('Data berhasil diubah', function() {
                            $("#batal").click();
