      ...
      <tr>
        <td>
          <table class="table table-sm" width="100%">
            ...
            <tr>
              <th width="20%">Hasil Survey</th>
              <td>: <?= $key['hasil_survey']; ?></td>
            </tr>
            <tr>
              <th width="20%">Keterangan Survey</th>
              <td>: <?= $key['keterangan_survey']; ?></td>
            </tr>
          </table>
        </td>
        <td>
        ...
        <td>
          <div class="btn-group">
              <button type="button" class="btn btn-warning btn-sm" onclick="edit('<?= $key['id']; ?>','survey');" data-toggle="tooltip" data-placement="left" title="Edit Data <?= $key['nama_debitur']; ?>"><i class="fas fa-wrench"></i></button>
              <button type="button" class="btn btn-danger btn-sm" onclick="destroy('<?= $key['id']; ?>','survey');" data-toggle="tooltip" data-placement="left" title="Hapus Data <?= $key['nama_debitur']; ?>"><i class="fas fa-trash"></i></button>
            </div>
        </td>
      </tr>
    <?php $no++; endforeach; ?>
