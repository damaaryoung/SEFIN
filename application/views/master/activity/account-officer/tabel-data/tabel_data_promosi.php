      ...
      <tr>
        ...
        <td>
          <div class="btn-group">
            ...
            <button type="button" class="btn btn-danger btn-sm" onclick="destroy('<?= $key['id']; ?>','promosi');" data-toggle="tooltip" data-placement="left" title="Hapus Data <?= $key['tanggal']; ?>"><i class="fas fa-trash"></i></button>
          </div>
        </td>
      </tr>
      <?php $no++; endforeach; ?>
