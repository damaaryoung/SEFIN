<table class="table table-sm table-hover table-bordered">
  <thead>
      <tr>
          ...
          <th width="100">Nama Debitur</th>
          <th width="100">Alamat Domisili</th>
    ...
    <?php foreach ($data as $key): ?>
      <tr>
        ...
        <td>
          ...
          <?php } else {?>
            <img src="<?= $this->config->item('api_url').$key['swafoto']; ?>" class="rounded mx-auto d-block" alt="..." width="30%">
          <?php } ?>
        </td>
        <td>
          <div class="btn-group">
              <button type="button" class="btn btn-warning btn-sm" onclick="edit('<?= $key['id']; ?>','visitEdit');" data-toggle="tooltip" data-placement="left" title="Edit Data <?= $key['tanggal']; ?>"><i class="fas fa-wrench"></i></button>
