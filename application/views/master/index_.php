...
<head>
  ...
  <title>SEFIN | BPR Kredit Mandiri</title>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #da1326;">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-non5e d-sm-inline-block">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
            <img src="<?php echo base_url('assets/dist/img/user1.png') ?>" style="max-width: 42px;  margin-top: -7px">
          </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #B10001">
      ...
      <a href="<?php echo base_url() ?>" class="brand-link" style="background-color: #fff">
        <img src="<?php echo base_url('assets/dist/img/sefin-system.png') ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8;">
        <span class="brand-text font-weight-light" style="color: #4a4747">Secure Finance System</span>
      </a>
      ...
      <div class="sidebar">
        <nav class="mt-2">
          ...
          <li class="nav-item has-treeview">
            <a href="" class="nav-link" style="color: #fff">
              <i class="nav-icon fas fa-bars" style="color: #FFDE00"></i>
              <p>
                Master
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview">
                <a href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon" style="color: #FFDE00"></i>
                  <p>
                    Wilayah
                    <i class="right fas fa-angle-left"></i>
                  </p>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a id="click-provinsi" href="" class="nav-link" style="color: #fff">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Provinsi</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a id="click-kabupaten" href="" class="nav-link" style="color: #fff">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Kabupaten</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a id="click-kecamatan" href="" class="nav-link" style="color: #fff">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Kecamatan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a id="click-kelurahan" href="" class="nav-link" style="color: #fff">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Kelurahan</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                <a id="click-asal-data" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Asal Data</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="click-area" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Area</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="click-kantor-cabang" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kantor Cabang</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="click-jenis-pic" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Jenis PIC</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="click-pic" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>PIC</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="click-area-pic" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Area PIC</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a id="click-memorandum-so" href=""  class="nav-link" style="color: #fff">
              <i class="nav-icon fas fa-edit" style="color: #FFDE00"></i>
              <p>
              Memorandum SO
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a id="click-das" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Proses</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="click-ds-spv" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Hasil</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a id="click-memorandum-ao" href="" class="nav-link" style="color: #fff">
              <i class="nav-icon fas fa-edit" style="color: #FFDE00"></i>
              <p>
              Memorandum AO
          ...
          <li class="nav-item">
            <a href="" id="click-memorandum-ca" class="nav-link" style="color: #fff">
              <i class="nav-icon fas fa-edit" style="color: #FFDE00"></i>
              <p>
              Memorandum CA
          ...
          <li class="nav-item">
            <a href="" id="click-caa" class="nav-link" style="color: #fff">
              <i class="nav-icon fas fa-newspaper" style="color: #FFDE00"></i>
              <p>
              Form CAA
          ...
          <li class="nav-item">
            <a href="" id="click-form-ol" class="nav-link" style="color: #fff">
              <i class="nav-icon fas  fa-file-pdf" style="color: #FFDE00"></i>
              <p>
              From OL
          ...
          <li class="nav-item has-treeview">
            <a href="" class="nav-link" style="color: #fff">
              <i class="nav-icon fas fa-users-cog" style="color: #FFDE00"></i>
              <p>
                Setting
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a id="click-menu" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Menu</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="click-submenu" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sub Menu</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="click-user-access" href="" class="nav-link" style="color: #fff">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User Access</p>
                </a>
              </li>
