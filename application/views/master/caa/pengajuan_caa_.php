...
<div class="modal-body" style="height:500px; overflow-y:scroll">
    <form id="frm_pengajuan_caa" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-md-6">
                <small>Lampiran Usaha :</small>
                <a class="form-control form-control-sm" href="<?php echo $url_img.$pengajuan_lamp ?>" target="_blank"><i class="far fa-file"></i> Lihat Lampiran</a>
            </div>
        </div>
    ...
    $('input[type=radio][name=penyimpangan]').change(function(){
        ...
        if(data=='ADA') {
            ...
            $.ajax({
                ...
                data: "plafon="+plafonPengajuan+"&nst="+data+"&cabang="+cabang,
                beforeSend: function(){
