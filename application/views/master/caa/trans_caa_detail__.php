...
<div class="modal-body" style="height:500px; overflow-y:scroll">
    ...
    <script>
        ...
        function radio_done() {
            ...
            // } else 
            if (status == 'forward' && id_mj_pic == ' 9' && plafon > plafon_max && penyimpangan == ' TIDAK ADA') {
                var radio_done = "" +
                    "<input type='radio' name='status_crm' value=''> " +
                ...
                $('.radio_accept').html(radio_accept);
                $('#not_recommend').hide();
            } else if (status == 'forward' && id_mj_pic == ' 9' && plafon > plafon_max && penyimpangan == ' ADA') {
                var radio_done = "" +
                ...
                $('.radio_accept').html(radio_accept);
                $('#not_recommend').hide();
            } else if (status == 'forward' && id_mj_pic == ' 9' && plafon <= plafon_max) {
                var radio_done = "" +
                    "<input type='radio' name='status_crm' value='Ya'> " +
                    "<input type='radio' hidden name='status' value='forward' checked> " +
                    "<small>Ya</small>";
                ...
                var radio_accept = "" +
                    "<input type='radio' name='status' value='accept'><small>Accept</small>";
                $('.radio_accept').html(radio_accept);
            } else if (status == 'forward' && id_mj_pic == ' 11') {
                var radio_done = "" +
                    "<input type='radio' name='status' value='<?php echo $status_app ?>'> " +
                    "<small><?php echo ucfirst($status_app) . $forward_to ?></small>";
                $('.radio_done').html(radio_done);
