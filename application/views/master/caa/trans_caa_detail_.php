            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control form-control-sm" value="<?php echo strtoupper($penyimpangan) ?>" readonly>
                    </div>
                    <div class="col-md-2">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <textarea name="rincian" class="form-control form-control-sm" placeholder="1P + 5C (CA)" rows="5" readonly><?php echo '' ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <small class="text-warning"><b>Non Standard Transaction:</b></small>
                        <textarea name="rincian" class="form-control form-control-sm" placeholder="Non Standard Transaction" rows="5" readonly><?php echo '' ?></textarea>
                    </div>
                </div>
            </div>
