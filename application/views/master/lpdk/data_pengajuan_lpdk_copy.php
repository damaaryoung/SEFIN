                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_ktp_deb">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_ktp_debitur">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4" id="form_ktp_pasangan_deb">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_ktp_pas">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_ktp_pas">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4" id="form_ktp_pasangan_deb">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_ktp_pen">
                                                                    <img src="https://goo.gl/pB9rpQ" id="tampil_modal_ktp_penjamin">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4" id="form_ktp_pasangan_deb">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_ktp_pas">
                                                                    <img src="https://goo.gl/pB9rpQ" id="tampil_modal_buku_nikah_penjamin">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4" id="form_ktp_pemilik_sertifikat">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_ktp_pem_sertifikat">
                                                                    <img src="https://goo.gl/pB9rpQ" id="tampil_modal_ktp_pem_sertifikat">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4" id="form_ktp_pasangan_pemilik_sertifikat">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_ktp_pas_pem_sertifikat">
                                                                    <img src="https://goo.gl/pB9rpQ" id="tampil_modal_ktp_pas_pem_sertifikat">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_kk">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_kk">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_npwp">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_npwp">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_surat_nikah">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_surat_nikah">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_surat_cerai">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_surat_cerai">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_surat_lahir">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_surat_lahir">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_surat_kematian">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_surat_kematian">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_surat_ket_desa">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_surat_ket_desa">
                                                                </label>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_sertifikat">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_sertifikat">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_pbb">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_pbb">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_imb">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_imb">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_ajb_ppjb">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_ajb">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_ahli_waris">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_ahli_waris">
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <div class="image-upload">
                                                                ...
                                                                <label for="lamp_akta_hibah">
                                                                    <img src="https://goo.gl/pB9rpQ" data-toggle="modal" data-target="#modal_akt_hibah">
                                                                </label>
                                                            </div>
            ...
            <div class="modal-content sm">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <textarea type="file" name="notes_counter" class="form-control" style="height: 188px" onkeyup="this.value = this.value.toUpperCase()"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<script type="text/javascript">
    ...
    //TAMBAH LAMPIRAN
    tambah_lampiran_lpdk = function(opts, id) {
    ...
    //UBAH DATA PENJAMIN
    ubah_penjamin = function(opts, id, id_so) {
        var url = '<?php echo $this->config->item('api_url'); ?>api/master/lpdk/edit/' + id_so + '/penjamin/' + id;
        var data = opts;
        return $.ajax({
            url: url,
            data: data,
            ...
            .done(function(response) {
                ...
                function format(data) {
                    ...
                    $.each(data.sertifikat, function(index, item) {
                        ...
                        // lamp_jaminan_sertifikat = new Array(item.lampiran_sertifikat);
                        // lamp_jaminan_imb = new Array(item.lampiran_imb);
                        // lamp_jaminan_pbb = new Array(item.lampiran_pbb);
                        // lamp_jaminan_ahli_waris = new Array(item.ahli_waris);
                        // lamp_jaminan_ajb_ppjb = new Array(item.ajb_ppjb);
                        // lamp_jaminan_akta_hibah = new Array(item.akta_hibah);
                        // x = lamp_jaminan_sertifikat.join(',');
                        // imb = lamp_jaminan_imb.join(',');
                        // pbb = lamp_jaminan_pbb.join(',');
                        // ahli_waris = lamp_jaminan_ahli_waris.join(',');
                        // ajb_ppjb = lamp_jaminan_ajb_ppjb.join(',');
                        // akta_hibah = lamp_jaminan_akta_hibah.join(',');
                        console.log(item.lampiran_sertifikat)
                        ...
                        b = '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.lampiran_sertifikat + '"><p class="hide_ktp_deb" style="font-size: 13px; font-weight: 400;">' + lampiran_sertifikat + '</p></a><a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.lampiran_imb + '"><p class="hide_ktp_deb" style="font-size: 13px; font-weight: 400;">' + lampiran_imb_sertifikat + '</p></a><a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.lampiran_pbb + '"><p class="hide_ktp_deb" style="font-size: 13px; font-weight: 400;">' + lampiran_pbb_sertifikat + '</p></a><a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.ahli_waris + '"><p class="hide_ktp_deb" style="font-size: 13px; font-weight: 400;">' + lampiran_ahli_waris_sertifikat + '</p></a><a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.ajb_ppjb + '"><p class="hide_ktp_deb" style="font-size: 13px; font-weight: 400;">' + lampiran_ajb_sertifikat + '</p></a><a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.akta_hibah + '"><p class="hide_ktp_deb" style="font-size: 13px; font-weight: 400;">' + lampiran_akta_hibah_sertifikat + '</p></a>'
                    })
                    ...
                    var notes_counter = data.notes_counter;
                    if (notes_counter == '') {
                        var notes_counter_hide = "hidden";
                    } else
                    if (notes_counter == null) {
                        var notes_counter_hide = "hidden";
                    } else {
                        var notes_counter_hide = "";
                    }

                    var notes_progress = data.notes_progress;
                    if (notes_progress == '') {
                        var notes_progress_hide = "hidden";
                    } else
                    if (notes_progress == null) {
                        var notes_progress_hide = "hidden";
                    } else {
                        var notes_progress_hide = "";
                    }
                    ...
                    return '<table cellpadding="5" class="table table-bordered table-hover table-sm" cellspacing="0" border="0" style="padding-left:50px;">' +
                        ...
                        '<td><a id="lampiran_ktp_deb_detail" ' + lamp_ktp_deb + ' class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_debitur.lampiran_ktp_deb + '"><p class="hide_ktp_deb" style="font-size: 13px; font-weight: 400;">' + lamp_ktp_debitur + '</p></a><a id="lampiran_kk_deb_detail" ' + lamp_kk_deb + ' class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_debitur.lampiran_kk + '"><p style="font-size: 13px; font-weight: 400;">' + lamp_kk_debitur + '</p></a><a id="lampiran_ktp_pas_detail" ' + lamp_ktp_pas + ' class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_pasangan.lampiran_ktp_pasangan + '"><p style="font-size: 13px; font-weight: 400;">' + lampiran_ktp_pasangan + '</p></a><a id="lampiran_npwp_deb_detail" ' + lamp_npwp + ' class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_npwp + '"><p style="font-size: 13px; font-weight: 400;">' + lampiran_npwp + '</p></a><a id="lampiran_surat_nikah_deb_detail" ' + lamp_buku_nikah_pas + ' class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_pasangan.lampiran_surat_nikah + '"><p style="font-size: 13px; font-weight: 400;">' + lamp_buku_nikah_pasangan + '</p></a><a id="lampiran_surat_cerai_deb_detail" ' + lamp_surat_cerai + ' class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_surat_cerai + '"><p style="font-size: 13px; font-weight: 400;">' + lampiran_surat_cerai + '</p></a><a id="lampiran_surat_kematian_deb_detail" ' + lamp_surat_kematian + ' class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_surat_kematian + '"><p style="font-size: 13px; font-weight: 400;">' + lampiran_surat_kematian + '</p></a><a id="lampiran_surat_lahir_deb_detail" ' + lamp_surat_lahir + ' class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_surat_lahir + '"><p style="font-size: 13px; font-weight: 400;">' + lampiran_surat_lahir + '</p></a><a id="lampiran_surat_ket_desa_deb_detail" ' + lamp_surat_ket_desa + ' class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_sk_desa + '"><p style="font-size: 13px; font-weight: 400;">' + lampiran_surat_ket_desa + '</p></a></td>' +
                        '<td>' + b + '</td>' +
                        '<td>' + data.updated_at + '</td>' +
                        '<td>' + data.request_by + '</td>' +
                        '<td> <p ' + notes_progress_hide + ' >' + data.notes_progress + '</p> <br><p ' + notes_counter_hide + ' >' + data.notes_counter + '</p></td>' +
                        '</tr>' +
                        '</table>'
                }
                ...
                $.each(data, function(index, item) {
                    ...
                    var tr = [
                        ...
                        '<button type="button" class="btn btn-default bg-gradient-danger btn-sm cancel" title="Cancel Pengajuan"  data="' + item.trans_so + '"><i style="color: #fff;" class="fas fa-window-close"></i></button>',
    ...
    $('#data_pengajuan').on('click', '.edit', function(e) {
        ...
        get_pengajuan({}, id)
            .done(function(response) {
                ...
                var a = [
                    '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_ktp_deb + '"><p style="font-size: 13px; font-weight: 400;">1. KTP Debitur</p></a>'
                ].join('\n');
                html.push(a);
                $('#file_ktp').html(html);

                var b = [
                    '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_ktp_pasangan + '"><p style="font-size: 13px; font-weight: 400;">1. KTP Pasangan</p></a>'
                ].join('\n');
                html1.push(b);
                ...
                $.each(data.penjamin, function(index, item) {
                    ...
                    if (item.lamp_ktp == null) {
                        ...
                        var c = [
                            '<a class="example-image-link" target="window.open()"  href="<?php echo $this->config->item('img_url') ?>' + item.lamp_ktp + '"><p style="font-size: 13px; font-weight: 400;">' + urut_penjamin + ' .KTP Penjamin</p></a>',
                        ].join('\n');
                        html3.push(c);
                        $('#file_ktp_pen').html(html3);
                    }
                ...
                var d = [
                    '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_kk + '"><p style="font-size: 13px; font-weight: 400;">1. KK Debitur</p></a>'
                ].join('\n');
                html4.push(d);
                $('#file_kk').html(html4);

                var e = [
                    '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lamp_buku_nikah + '"><p style="font-size: 13px; font-weight: 400;">1. Buku NIkah Debitur</p></a>'
                ].join('\n');
                html5.push(e);
                ...
                if (data.lampiran_npwp == null) {
                    ...
                    var h = [
                        '<a class="example-image-link" target="window.open()"  href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_npwp + '"><p style="font-size: 13px; font-weight: 400;">1. NPWP</p></a>',
                    ].join('\n');
                    html8.push(h);
                    $('#file_npwp').html(html8);
                }
                ...
                if (data.lampiran_surat_cerai == null) {
                    ...
                    var i = [
                        '<a class="example-image-link" target="window.open()"  href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_surat_cerai + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Cerai</p></a>',
                    ].join('\n');
                    html9.push(i);
                    $('#file_surat_cerai').html(html9);
                }
                ...
                if (data.lampiran_surat_lahir == null) {
                    ...
                    var j = [
                        '<a class="example-image-link" target="window.open()"  href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_surat_lahir + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Lahir</p></a>',
                    ].join('\n');
                    html10.push(j);
                    $('#file_surat_lahir').html(html10);
                }
                ...
                if (data.lampiran_surat_kematian == null) {
                    ...
                    var k = [
                        '<a class="example-image-link" target="window.open()"  href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_surat_kematian + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Kematian</p></a>',
                    ].join('\n');
                    html11.push(k);
                    $('#file_surat_kematian').html(html11);
                }
                ...
                if (data.lampiran_surat_keterangan_desa == null) {
                    ...
                    var l = [
                        '<a class="example-image-link" target="window.open()"  href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_surat_keterangan_desa + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Ket Desa</p></a>',
                    ].join('\n');
                    html12.push(l);
                    $('#file_surat_ket_desa').html(html12);
                }
                ...
                $.each(data.sertifikat, function(index, item) {
                    ...
                    if (item.lamp_imb == null) {
                        ...
                        var f = [
                            '<a class="example-image-link" target="window.open()"  href="<?php echo $this->config->item('img_url') ?>' + item.lamp_imb + '"><p style="font-size: 13px; font-weight: 400;">' + urut_imb + ' .IMB</p></a>',
                        ].join('\n');
                        html6.push(f);
                        $('#file_imb').html(html6);
                    }
                ...
                $.each(data.sertifikat, function(index, item) {
                    ...
                    if (item.lamp_pbb == null) {
                        ...
                        var g = [
                            '<a class="example-image-link" target="window.open()"  href="<?php echo $this->config->item('img_url') ?>' + item.lamp_pbb + '"><p style="font-size: 13px; font-weight: 400;">' + urut_pbb + ' .PBB</p></a>',
                        ].join('\n');
                        html7.push(g);
                        $('#file_pbb').html(html7);
                    }
    ...
    $('#data_pengajuan_lpdk').on('click', '.edit', function(e) {
        ...
        get_detail_lpdk({}, id)
            .done(function(response) {
                ...
                $('#form_tambah_ktp_deb input[name=id_debitur_ktp]').val(data.trans_so);
                $('#form_tambah_ktp_pas input[name=id_debitur_ktp_pas]').val(data.trans_so);
                $('#form_tambah_kk input[name=id_debitur_kk]').val(data.trans_so);
                $('#form_tambah_npwp input[name=id_debitur_npwp]').val(data.trans_so);
                $('#form_tambah_surat_nikah input[name=id_debitur_nikah]').val(data.trans_so);
                ...
                if (data.lampiran_debitur.lampiran_ktp_deb == null) {
                    ...
                    var a = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_debitur.lampiran_ktp_deb + '"><p style="font-size: 13px; font-weight: 400;">1. KTP Debitur</p></a>'
                    ].join('\n');
                    html.push(a);
                    $('#file_ktp').html(html);
                }
                ...
                if (data.lampiran_pasangan.lampiran_ktp_pasangan == null) {
                    ...
                    var b = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_pasangan.lampiran_ktp_pasangan + '"><p style="font-size: 13px; font-weight: 400;">1. KTP Pasangan</p></a>'
                    ].join('\n');
                    html1.push(b);
                    $('#file_ktp_pas').html(html1);
                }
                ...
                if (data.lampiran[0].lampiran_surat_cerai == null) {
                    ...
                    var c = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_surat_cerai + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Cerai</p> </a>'
                    ].join('\n');
                    html2.push(c);
                    $('#file_surat_cerai').html(html2);
                }
                ...
                if (data.lampiran[0].lampiran_surat_lahir == null) {
                    ...
                    var d = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_surat_lahir + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Lahir</p> </a>'
                    ].join('\n');
                    html3.push(d);
                    $('#file_surat_lahir').html(html3);
                }
                ...
                if (data.lampiran[0].lampiran_surat_kematian == null) {
                    ...
                    var e = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_surat_kematian + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Kematian</p></a>'
                    ].join('\n');
                    html4.push(e);
                    $('#file_surat_kematian').html(html4);
                }
                ...
                if (data.lampiran[0].lampiran_sk_desa == null) {
                    ...
                    var f = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_sk_desa + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Keterangan Desa/PM1/PM2</p></a>'
                    ].join('\n');
                    html5.push(f);
                    $('#file_surat_ket_desa').html(html5);
                }
                ...
                if (data.lampiran_pasangan.lampiran_surat_nikah == null) {
                    ...
                    var g = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran_pasangan.lampiran_surat_nikah + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Nikah</p> </a>'
                    ].join('\n');
                    html6.push(g);
                    $('#file_surat_nikah').html(html6);
                }
                ...
                if (data.lampiran[0].lampiran_npwp == null) {
                    ...
                    var h = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_npwp + '"><p style="font-size: 13px; font-weight: 400;">1. NPWP</p> </a>'
                    ].join('\n');
                    html7.push(h);
                    $('#file_npwp').html(html7);
                }
                ...
                if (data.lampiran_debitur.lampiran_kk == null) {
                    ...
                    var i = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_kk + '"><p style="font-size: 13px; font-weight: 400;">1. Kartu Keluarga</p></a>'
                    ].join('\n');
                    html8.push(i);
                    $('#file_kk').html(html8);
                }
                ...
                $.each(data.penjamin, function(index, item) {
                    ...
                    if (item.lampiran_ktp_penjamin == null) {
                        ...
                        var j = [
                            '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.lampiran_ktp_penjamin + '"><p style="font-size: 13px; font-weight: 400;">' + urut_penjamin + ' .KTP Penjamin</p></a>',
                        ].join('\n');
                        html9.push(j);
                        $('#file_ktp_pen').html(html9);
                    }
                ...
                $.each(data.penjamin, function(index, item) {
                    ...
                    if (item.buku_nikah_penjamin == null) {
                        ...
                        var j = [
                            '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.buku_nikah_penjamin + '"><p style="font-size: 13px; font-weight: 400;">' + urut_buk_nik_pen + ' .Buku Nikah Penjamin</p></a>',
                        ].join('\n');
                        html19.push(j);
                        $('#file_buku_nikah_pen').html(html19);
                    }
                ...
                $.each(data.sertifikat, function(index, item) {
                    ...
                    if (item.lampiran_ktp_sertifikat == null) {
                        ...
                        var k = [
                            '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.lampiran_ktp_sertifikat + '"><p style="font-size: 13px; font-weight: 400;">' + urut_sertifikat + ' .KTP Pemilik Sertifikat</p></a>',
                        ].join('\n');
                        html10.push(k);
                        $('#file_ktp_pem_sertifikat').html(html10);
                    }
                    ...
                    if (item.lampiran_ktp_pasangan_sertifikat == null) {
                        ...
                        var l = [
                            '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.lampiran_ktp_pasangan_sertifikat + '"><p style="font-size: 13px; font-weight: 400;">' + urut_sertifikat + ' .KTP Pemilik Sertifikat</p></a>',
                        ].join('\n');
                        html11.push(l);
                        $('#file_ktp_pas_pem_sertifikat').html(html11);
                    }
                    ...
                    if (item.lampiran_sertifikat == null) {
                        ...
                        var m = [
                            '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.lampiran_sertifikat + '"><p style="font-size: 13px; font-weight: 400;">' + urut_sertifikat + ' . Sertifikat</p></a>',
                        ].join('\n');
                        html12.push(m);
                        $('#file_sertifikat').html(html12);
                    }
                    ...
                    if (item.lampiran_pbb == null) {
                        ...
                        var n = [
                            '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.lampiran_pbb + '"><p style="font-size: 13px; font-weight: 400;">' + urut_sertifikat + ' . PBB</p></a>',
                        ].join('\n');
                        html13.push(n);
                        $('#file_pbb').html(html13);
                    }
                    ...
                    if (item.lampiran_imb == null) {
                        ...
                        var o = [
                            '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.lampiran_imb + '"><p style="font-size: 13px; font-weight: 400;">' + urut_sertifikat + ' . IMB</p></a>',
                        ].join('\n');
                        html14.push(o);
                        $('#file_imb').html(html14);
                    }
                    ...
                    if (item.ajb_ppjb == null) {
                        ...
                        var p = [
                            '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.ajb_ppjb + '"><p style="font-size: 13px; font-weight: 400;">' + urut_sertifikat + ' . AJB/PPJB</p></a>',
                        ].join('\n');
                        html15.push(p);
                        $('#file_ajb_ppjb').html(html15);
                    }
                    ...
                    if (item.ahli_waris == null) {
                        ...
                        var q = [
                            '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.ahli_waris + '"><p style="font-size: 13px; font-weight: 400;">' + urut_sertifikat + ' . Ahli Waris</p></a>',
                        ].join('\n');
                        html16.push(q);
                        $('#file_ahli_waris').html(html16);
                    }
                    ...
                    if (item.akta_hibah == null) {
                        ...
                        var r = [
                            '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + item.akta_hibah + '"><p style="font-size: 13px; font-weight: 400;">' + urut_sertifikat + ' . Akta Hibah</p></a>',
                        ].join('\n');
                        html17.push(r);
                        $('#file_akta_hibah').html(html17);
                    }
        ...
        update_debitur_lamp(formData, id)
            .done(function(res) {
                ...
                bootbox.alert('Lampiran berhasil disimpan', function() {
                    ...
                    var html = [];
                    var a = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lamp_ktp + '"><p style="font-size: 13px; font-weight: 400;">1. KTP Debitur</p></a>'
                    ].join('\n');
                    html.push(a);
                    $('#file_ktp').html(html);
                })
        ...
        update_lampiran_pasangan(formData, id)
            .done(function(res) {
                ...
                bootbox.alert('Lampiran berhasil disimpan', function() {
                    ...
                    var html1 = [];
                    var a = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lamp_ktp + '"><p style="font-size: 13px; font-weight: 400;">1. KTP Pasangan</p> </a>'
                    ].join('\n');
                    html1.push(a);
                    $('#file_ktp_pas').html(html1);
        ...
        update_debitur_lamp(formData, id)
            .done(function(res) {
                ...
                bootbox.alert('Lampiran berhasil disimpan', function() {
                    ...
                    var html = [];
                    var a = [
                        '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lamp_kk + '"><p style="font-size: 13px; font-weight: 400;">1. KK Debitur</p></a>'
                    ].join('\n');
                    html.push(a);
                    $('#file_kk').html(html);
                })
    ...
    load_lampiran_surat_nikah = function() {
        ...
        get_detail_lpdk({}, id)
            .done(function(response) {
                ...
                var html1 = [];
                var a = [
                    '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_surat_nikah + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Nikah</p></a>'
                ].join('\n');
                html1.push(a);
                $('#file_surat_nikah').html(html1);
            })
    ...
    load_lampiran_surat_ket_desa = function() {
        ...
        get_detail_lpdk({}, id)
            .done(function(response) {
                ...
                var html1 = [];
                var a = [
                    '<a class="example-image-link" target="window.open()" href="<?php echo $this->config->item('img_url') ?>' + data.lampiran[0].lampiran_sk_desa + '"><p style="font-size: 13px; font-weight: 400;">1. Surat Ket Desa/PM1/PM2</p></a>'
                ].join('\n');
                html1.push(a);
            ...
            .done(function(response) {
                ...
                $.each(data.sertifikat, function(index, item) {
                    ...
                    if (item.lampiran_ktp_pasangan_sertifikat == null) {
                        ...
                        var k = [
                            '<a class="example-image-link" target="window.open()"  href="<?php echo $this->config->item('img_url') ?>' + item.lampiran_ktp_pasangan_sertifikat + '"><p style="font-size: 13px; font-weight: 400;">' + urut_sertifikat + '. KTP Pasangan Pemilik Sertifikat</p></a>',
                        ].join('\n');
                        html.push(k);
                        $('#file_ktp_pas_pem_sertifikat').html(html);
                    }
            ...
            .done(function(response) {
                ...
                $.each(data.penjamin, function(index, item) {
                    ...
                    if (item.buku_nikah_penjamin == null) {
                        ...
                        var c = [
                            '<a class="example-image-link" target="window.open()"  href="<?php echo $this->config->item('img_url') ?>' + item.buku_nikah_penjamin + '"><p style="font-size: 13px; font-weight: 400;">' + urut_penjamin + ' .Buku Nikah Penjamin</p></a>',
                        ].join('\n');
                        html3.push(c);
                        $('#file_buku_nikah_pen').html(html3);
                    }
