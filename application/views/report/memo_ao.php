         ...
         <table border="0" style="width: 100%;font-size: 10px; vertical-align: top">
            <tr>
               <th colspan="6" align="center" style="background-color: red;color: white;font-size: 12px">
                  <center>MEMORANDUM ACCOUNT OFFICER</center>
               </th>
            </tr>
            <tr>
            ...
            <tbody style="font-size: 8px;">
               <tr>
                  ...
                  <td width="120">Nama Account Officer</td>
                  <td width="2">:</td>
                  <td><?php echo $nama_ao ?></td>
               </tr>
               <tr>
                  <td>Nama Sales Officer</td>
                  <td width="2">:</td>
               ...
               <tr>
                  ...
                  <td>Jenis kelamin</td>
                  <td width="2">:</td>
                  <td><?php echo $jenis_kelamin_pasangan ?></td>
               </tr>
               <tr>
                  <td>Nama ibu kandung</td>
                  <td width="2">:</td>
               ...
               <tr>
                  ...
                  <td>Nama Perusahaan / Usaha</td>
                  <td>:</td>
                  <td><?php echo $nama_tempat_kerja_pasangan ?></td>
               </tr>
               <tr>
                  <td>Posisi</td>
                  <td>:</td>
               ...
               if ($row !== 0) :
                  foreach ($row->result_array() as $data) {
                     ...
                     $jenis_kelamin_penjamin = $data['jenis_kelamin'];
                     ...
                     echo  '<tr>
                              ...
                              <tr>
                                 <td>Alamat lengkap usaha / kantor</td>
                                 <td width="2">:</td>
                                 <td colspan ="3">' . $nama_tempat_kerja_penjamin . '</td>
                              </tr>
                              <tr>
                                 <td>Provinsi</td>
                                 <td width="2">:</td>
...
WHERE id_trans_so = '$id_trans_so'";
               ...
               <tr>
                  <th colspan="6" align="left" style="background-color: yellow;font-size: 10px">PEMERIKSAAN TANAH DAN BANGUNAN</th>
               </tr>
               <tr>
                  <td>Nama Penghuni</td>
                  <td width="2">:</td>
                  <td><?php echo $nama_penghuni ?></td>
                  <td>Nilai Taksasi Bangunan</td>
                  <td width="2">:</td>
                  <td><?php echo number_format($nilai_taksasi_bangunan) ?></td>
               </tr>
               <tr>
                  <td>Status Penghuni</td>
                  <td width="2">:</td>
                  <td><?php echo $status_penghuni ?></td>
                  <td>Nilai Taksaksi Agunan</td>
                  <td width="2">:</td>
                  <td><?php echo number_format($nilai_taksasi_agunan) ?></td>
               </tr>
               <tr>
                  <td>Bentuk Agunan</td>
                  <td width="2">:</td>
                  <td><?php echo $bentuk_bangunan ?></td>
                  <td>Tanggal Taksasi Agunan</td>
                  <td width="2">:</td>
                  <td><?php echo $tgl_taksasi ?></td>
               </tr>
               <tr>
                  <td>Kondisi Agunan</td>
                  <td width="2">:</td>
                  <td><?php echo $kondisi_bangunan ?></td>
                  <td>Nilai Likuidasi</td>
                  <td width="2">:</td>
                  <td><?php echo number_format($nilai_likuidasi) ?></td>
               </tr>
               <tr>
                  <td>Fasilitas</td>
                  <td width="2">:</td>
                  <td><?php echo $fasilitas ?></td>
                  <td>Perusahaan Penilai Independen</td>
                  <td width="2">:</td>
                  <td><?php echo $perusahaan_penilai_independen ?></td>
               </tr>
               <tr>
                  <td>Listrik</td>
                  <td width="2">:</td>
                  <td><?php echo $listrik ?></td>
                  <td>Nilai Agunan Independen</td>
                  <td width="2">:</td>
                  <td><?php echo number_format($nilai_agunan_independen) ?></td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td width="2">:</td>
                  <td><?php echo $recom_tujuan_pinjaman ?></td>
                  <td>Suku bunga</td>
                  <td width="2">:</td>
               ...
               <tr>
                  ...
                  <td width="2">:</td>
                  <td><?php echo $recom_jenis_pinjaman ?></td>
                  <td>Pby Bunga / bulan</td>
                  <td width="2">:</td>
                  <td><?php echo $pembayaran_bunga ?></td>
               </tr>
               <tr>
                  <td>Produk</td>
                  <td width="2">:</td>
