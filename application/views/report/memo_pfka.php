...
<div class="book">
   <div class="page" style="font-size: 12px;">
      ...
      <p><b>No. Apl ID : <?php echo $nomor_so ?></b></p>
      <p><b>No. CAA &nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $nomor_caa ?></b></p>
      <p><b>Bekasi , <?php echo date('d-m-Y') ?></b></p>
      <p>Kepada Yth,<br><b>BAPAK / IBU <?php echo strtoupper($nama_lengkap) ?> <br><?php echo $alamat_domisili ?></b></p>
      <center>
         <p><b>Perihal : Persetujuan Fasilitas Kredit Angsuran</b></p>
      </center>
      <p>Dengan hormat ,</p>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sehubungan dengan permohonan fasilitas kredit Bapak / Ibu tertanggal <?php echo $tanggal_approval ?> kepada <b>PT. BPR KREDIT MANDIRI INDONESIA</b>, bersama ini kami sampaikan bahwa permohonan Bapak / Ibu secara prinsip telah disetujui dengan ketentukan dan kondisi sebagai berikut :</p><br>
      <table border="0" style="width: 100%;font-size: 12px; vertical-align:top" cellspacing="-1">
         ...
         for ($i = 0; $i < count($agunan_tanah); $i++) {
            ...
            $no_sertifikat = $agunan_tanah[$i]->no_sertifikat;
         ...
         <tr>
            <td>5.</td>
            <td>Premi asuransi kendaraan</td>
            <td>: <i>Rp. <?php echo number_format($biaya_asuransi_kendaraan) ?>,-</i></td>
         </tr>
         <tr>
            <td>6.</td>
            <td>Credit chceking</td>
            <td>: <i>Rp. <?php echo number_format($biaya_credit_checking) ?>,-</i></td>
         </tr>
         <tr>
            <td>7.</td>
            <td>Tabungan</td>
         ...
         <tr>
            ...
            <td colspan="2">
               <p>1. Pencairan dana dilakukan setelah penandatanganan perjanjian kredit antara debitur dengan Bank, dan berdasarkan persetujuan dari bank serta melengkapi semua dokumen yang disyaratkakn oleh Bank.</p>
               <p>2. Telah diserahkan asli sertipikat atas nama <b><?php echo isset($jenis) ? $jenis : '' ?> NO. <?php echo isset($no_sertifikat) ? $no_sertifikat : '' ?> A.N <?php echo isset($nama_pemilik_sertifikat) ? $nama_pemilik_sertifikat : '' ?></b> serta telah dicek keabsahannya di BPN setempat oleh notaris rekanan PT. BPR KREDIT MANDIRI INDONESIA</p>
         ...
         <tr>
            ...
            <td colspan="2">
               <p>1. Pelunasan dapat dilakukan setiap saat dan permohonan pelunasana dipercepat wajib diinformasikan kepada pihak Bank minimal 7 (tujuh) hari sebelumnya </p>
         ...
         <tr>
            ...
            <td colspan="2">
               <p>1. Permohonan ganti agunan wajib diinformasikan kepada pihak Bank untuk dianalisa ulang dan Bank berhak menyetujui / menolak permohonan tersebut</p>
            </td>
         </tr>
         <tr>
            <td colspan="4">
         ...
         <tr>
            ...
            <td colspan="2">
               <p>
                  <p>1. Bank sepenuhnya berhak untuk meninjau dan mengubah besarnya suku bunga atau sistem suku bunga sesuai dengan ketentuan / kebijakan yang berlaku di PT. BPR KREDIT MANDIRI INDONESIA </p>
      ...
      <table style="font-size: 12px;">
         <tr>
            <td colspan="2"><b>
                  <h3>PT BPR KREDIT MANDIRI INDONESIA,</h3>
               </b></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
         ...
         <tr>
            <td><b><u>Branch Manager</u></b></td>
            <td><b><u>Operasional Head</u></b></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
