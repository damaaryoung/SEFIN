    ...
    <section>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="box-body table-responsive no-padding" id="box_tabel">
...
<script>
    ...
    get_activity_v2 = function(filter,page){
            var requestBody = {
                page, filter
            }

            console.log(requestBody, "ini adalah request body")
            return $.ajax({
                url: "<?= base_url(); ?>Activity_tele_collection_controller/data",
                data:{page:page,filter:filter},
                type: "POST",
                success: function(response) {
                    $('#box_tabel').html(`<button class="btn btn-primary tambah" id="click_tambah_activity" style="margin-bottom: 9px;"><i class="fa fa-user-plus">Tambah</i></button>`);
                    $('#box_tabel').append(response);
                }
            })
        }

    function pagination_tabel_activity($page){
        var filter="";
        var page=$page;
        get_activity_v2(filter,page);
    }

    pagination_tabel_activity(1);
    ...
    $(function(){
        ...
        load_data_activity = function(pagin){
            console.log('triggered ketika loading')
